...
+ (nullable OpenDataMessage *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [OpenDataMessage fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
...
+ (nullable OpenPathMessage *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [OpenPathMessage fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
...
+ (instancetype)makeWithId:(nullable NSString *)id pagesCount:(nullable NSNumber *)pagesCount {
...
+ (nullable OpenReply *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [OpenReply fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
...
+ (nullable IdMessage *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [IdMessage fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
    @"id" : (self.id ?: [NSNull null]),
...
+ (nullable GetPageMessage *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [GetPageMessage fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
...
+ (nullable GetPageReply *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [GetPageReply fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
    @"id" : (self.id ?: [NSNull null]),
...
+ (nullable RenderPageMessage *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [RenderPageMessage fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
...
+ (nullable RenderPageReply *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [RenderPageReply fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
    @"width" : (self.width ?: [NSNull null]),
...
+ (nullable RegisterTextureReply *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [RegisterTextureReply fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
    @"id" : (self.id ?: [NSNull null]),
...
+ (nullable UpdateTextureMessage *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [UpdateTextureMessage fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
    @"documentId" : (self.documentId ?: [NSNull null]),
...
+ (nullable ResizeTextureMessage *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [ResizeTextureMessage fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
    @"textureId" : (self.textureId ?: [NSNull null]),
...
+ (nullable UnregisterTextureMessage *)nullableFromMap:(NSDictionary *)dict {
  return (dict) ? [UnregisterTextureMessage fromMap:dict] : nil;
}
- (NSDictionary *)toMap {
  return @{
    @"id" : (self.id ?: [NSNull null]),
...
void PdfxApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<PdfxApi> *api) {
  {
    ...
    if (api) {
      NSCAssert(
          [api respondsToSelector:@selector(openDocumentDataMessage:completion:)],
          @"PdfxApi api (%@) doesn't respond to @selector(openDocumentDataMessage:completion:)",
          api);
  ...
  }
  {
    ...
    if (api) {
      NSCAssert(
          [api respondsToSelector:@selector(openDocumentFileMessage:completion:)],
          @"PdfxApi api (%@) doesn't respond to @selector(openDocumentFileMessage:completion:)",
          api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    ...
    if (api) {
      NSCAssert(
          [api respondsToSelector:@selector(openDocumentAssetMessage:completion:)],
          @"PdfxApi api (%@) doesn't respond to @selector(openDocumentAssetMessage:completion:)",
          api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        OpenPathMessage *arg_message = GetNullableObjectAtIndex(args, 0);
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
        [[FlutterBasicMessageChannel alloc] initWithName:@"dev.flutter.pigeon.PdfxApi.closeDocument"
                                         binaryMessenger:binaryMessenger
                                                   codec:PdfxApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(closeDocumentMessage:error:)],
                @"PdfxApi api (%@) doesn't respond to @selector(closeDocumentMessage:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  {
    FlutterBasicMessageChannel *channel =
        [[FlutterBasicMessageChannel alloc] initWithName:@"dev.flutter.pigeon.PdfxApi.getPage"
                                         binaryMessenger:binaryMessenger
                                                   codec:PdfxApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getPageMessage:completion:)],
                @"PdfxApi api (%@) doesn't respond to @selector(getPageMessage:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  {
    FlutterBasicMessageChannel *channel =
        [[FlutterBasicMessageChannel alloc] initWithName:@"dev.flutter.pigeon.PdfxApi.renderPage"
                                         binaryMessenger:binaryMessenger
                                                   codec:PdfxApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(renderPageMessage:completion:)],
                @"PdfxApi api (%@) doesn't respond to @selector(renderPageMessage:completion:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  {
    FlutterBasicMessageChannel *channel =
        [[FlutterBasicMessageChannel alloc] initWithName:@"dev.flutter.pigeon.PdfxApi.closePage"
                                         binaryMessenger:binaryMessenger
                                                   codec:PdfxApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(closePageMessage:error:)],
                @"PdfxApi api (%@) doesn't respond to @selector(closePageMessage:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        IdMessage *arg_message = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
  ...
  }
  {
    ...
    if (api) {
      NSCAssert([api respondsToSelector:@selector(registerTextureWithError:)],
                @"PdfxApi api (%@) doesn't respond to @selector(registerTextureWithError:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
  ...
  {
    FlutterBasicMessageChannel *channel =
        [[FlutterBasicMessageChannel alloc] initWithName:@"dev.flutter.pigeon.PdfxApi.updateTexture"
                                         binaryMessenger:binaryMessenger
                                                   codec:PdfxApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(updateTextureMessage:completion:)],
                @"PdfxApi api (%@) doesn't respond to @selector(updateTextureMessage:completion:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  {
    FlutterBasicMessageChannel *channel =
        [[FlutterBasicMessageChannel alloc] initWithName:@"dev.flutter.pigeon.PdfxApi.resizeTexture"
                                         binaryMessenger:binaryMessenger
                                                   codec:PdfxApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(resizeTextureMessage:completion:)],
                @"PdfxApi api (%@) doesn't respond to @selector(resizeTextureMessage:completion:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
  ...
  }
  {
    FlutterBasicMessageChannel *channel = [[FlutterBasicMessageChannel alloc]
        ...
        binaryMessenger:binaryMessenger
                  codec:PdfxApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(unregisterTextureMessage:error:)],
                @"PdfxApi api (%@) doesn't respond to @selector(unregisterTextureMessage:error:)",
                api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
