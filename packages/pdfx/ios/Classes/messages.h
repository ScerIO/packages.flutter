...
@protocol PdfxApi
- (void)openDocumentDataMessage:(OpenDataMessage *)message
                     completion:(void (^)(OpenReply *_Nullable, FlutterError *_Nullable))completion;
- (void)openDocumentFileMessage:(OpenPathMessage *)message
                     completion:(void (^)(OpenReply *_Nullable, FlutterError *_Nullable))completion;
- (void)openDocumentAssetMessage:(OpenPathMessage *)message
                      completion:
...
- (void)getPageMessage:(GetPageMessage *)message
            completion:(void (^)(GetPageReply *_Nullable, FlutterError *_Nullable))completion;
- (void)renderPageMessage:(RenderPageMessage *)message
...
- (void)updateTextureMessage:(UpdateTextureMessage *)message
                  completion:(void (^)(FlutterError *_Nullable))completion;
- (void)resizeTextureMessage:(ResizeTextureMessage *)message
                  completion:(void (^)(FlutterError *_Nullable))completion;
- (void)unregisterTextureMessage:(UnregisterTextureMessage *)message
                           error:(FlutterError *_Nullable *_Nonnull)error;
@end

extern void PdfxApiSetup(id<FlutterBinaryMessenger> binaryMessenger,
                         NSObject<PdfxApi> *_Nullable api);
