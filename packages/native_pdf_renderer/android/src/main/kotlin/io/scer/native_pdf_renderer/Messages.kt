...
class Messages(private val binding : FlutterPlugin.FlutterPluginBinding,
    ...
    override fun updateTexture(
        ...
        document.openPage(pageNumber).use { page ->
            ...
            if (width <= 0 || height <= 0) {
                result.error(PdfRendererException("PDF_RENDER", "updateTexture width/height == 0", null))
            }
            ...
            try {
                ...
                result.error(PdfRendererException("PDF_RENDER", "updateTexture Unknown error", null))
            }
