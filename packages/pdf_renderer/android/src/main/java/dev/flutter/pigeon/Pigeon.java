...
public class Pigeon {
  ...
  public static class GetPageMessage {
    ...
    public Boolean getAutoCloseAndroid() { return autoCloseAndroid; }
    public void setAutoCloseAndroid(Boolean setterArg) { this.autoCloseAndroid = setterArg; }
  ...
  public static class UpdateTextureMessage {
    ...
    public Long getSourceX() { return sourceX; }
    public void setSourceX(Long setterArg) { this.sourceX = setterArg; }

    private Long sourceY;
    public Long getSourceY() { return sourceY; }
    public void setSourceY(Long setterArg) { this.sourceY = setterArg; }

    private Long destinationX;
    public Long getDestinationX() { return destinationX; }
    public void setDestinationX(Long setterArg) { this.destinationX = setterArg; }

    private Long destinationY;
    public Long getDestinationY() { return destinationY; }
    public void setDestinationY(Long setterArg) { this.destinationY = setterArg; }

    private Double fullWidth;
    public Double getFullWidth() { return fullWidth; }
    public void setFullWidth(Double setterArg) { this.fullWidth = setterArg; }

    private Double fullHeight;
    public Double getFullHeight() { return fullHeight; }
    public void setFullHeight(Double setterArg) { this.fullHeight = setterArg; }

    private Long textureWidth;
    public Long getTextureWidth() { return textureWidth; }
    public void setTextureWidth(Long setterArg) { this.textureWidth = setterArg; }

    private Long textureHeight;
    public Long getTextureHeight() { return textureHeight; }
    public void setTextureHeight(Long setterArg) { this.textureHeight = setterArg; }

    private Boolean allowAntiAliasing;
    public Boolean getAllowAntiAliasing() { return allowAntiAliasing; }
    public void setAllowAntiAliasing(Boolean setterArg) { this.allowAntiAliasing = setterArg; }
    ...
    static UpdateTextureMessage fromMap(Map<String, Object> map) {
      ...
      fromMapResult.sourceX = (sourceX == null) ? null : ((sourceX instanceof Integer) ? (Integer)sourceX : (Long)sourceX);
      Object sourceY = map.get("sourceY");
      fromMapResult.sourceY = (sourceY == null) ? null : ((sourceY instanceof Integer) ? (Integer)sourceY : (Long)sourceY);
      Object destinationX = map.get("destinationX");
      fromMapResult.destinationX = (destinationX == null) ? null : ((destinationX instanceof Integer) ? (Integer)destinationX : (Long)destinationX);
      Object destinationY = map.get("destinationY");
      fromMapResult.destinationY = (destinationY == null) ? null : ((destinationY instanceof Integer) ? (Integer)destinationY : (Long)destinationY);
      ...
      fromMapResult.textureWidth = (textureWidth == null) ? null : ((textureWidth instanceof Integer) ? (Integer)textureWidth : (Long)textureWidth);
      Object textureHeight = map.get("textureHeight");
      fromMapResult.textureHeight = (textureHeight == null) ? null : ((textureHeight instanceof Integer) ? (Integer)textureHeight : (Long)textureHeight);
      ...
      } else 
{
  ...
  public interface PdfRendererApi {
    ...
    static void setup(BinaryMessenger binaryMessenger, PdfRendererApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.PdfRendererApi.registerTexture", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.PdfRendererApi.updateTexture", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.PdfRendererApi.resizeTexture", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.PdfRendererApi.unregisterTexture", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
