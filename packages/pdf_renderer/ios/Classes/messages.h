...
- (void)updateTextureMessage:(nullable UpdateTextureMessage *)message completion:(void(^)(FlutterError *_Nullable))completion;
- (void)resizeTextureMessage:(nullable ResizeTextureMessage *)message completion:(void(^)(FlutterError *_Nullable))completion;
